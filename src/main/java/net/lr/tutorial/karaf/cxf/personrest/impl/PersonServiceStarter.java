...
public class PersonServiceStarter {
    ...
    public void startRestService() {
        ...
        factory.setAddress("http://localhost:8282/entrophy");
        factory.setResourceClasses(ThresholdServiceImpl.class);
        factory.setResourceProvider(new SingletonResourceProvider(new ThresholdServiceImpl()));
